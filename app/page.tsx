          ...
          <div className="py-8 px-4 p-0-screen-sm mx-auto w-screen-sm-max max-w-screen-xl lg:py-16 lg:px-6">
            <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
              ...
              <p className="mb-5 font-light text-gray-500 sm:text-xl ">
                We offer a variety of transport options to suit your needs.
              </p>
            </div>
            <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
              <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                <h3 className="mb-4 text-2xl font-semibold">Complete Shared</h3>
              ...
              <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                <h3 className="mb-4 text-2xl font-semibold">Scala Shared</h3>
                <p className="font-light text-gray-500 sm:text-lg ">
                  Get on with another 3 passangers and share the cost.
                </p>
                <div className="flex justify-center items-baseline my-8">
              ...
              <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                <h3 className="mb-4 text-2xl font-semibold">Complete Alone</h3>
                <p className="font-light text-gray-500 sm:text-lg ">
              ...
              <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                <h3 className="mb-4 text-2xl font-semibold">Scala Alone</h3>
                <p className="font-light text-gray-500 sm:text-lg ">
                  Get the service just for you
                </p>
                <div className="flex justify-center items-baseline my-8">
              ...
              <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                ...
                <p className="font-light text-gray-500 sm:text-lg ">
                  Chat with us and we will find the best solution for you.
                </p>
                <div className="flex justify-center items-baseline my-8">
